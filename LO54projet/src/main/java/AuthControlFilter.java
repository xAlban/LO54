 ...
 * @author fburatto
 */
@WebFilter(filterName = "AuthControlFilter", urlPatterns = {"/restricted/*"})
public class AuthControlFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("AuthControlFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("AuthControlFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("AuthControlFilter:doFilter()");
        }
        
        //doBeforeProcessing(request, response);
        
        //  http://localhost:8080/LO54projet/tutu.html
        ...
        try {
            ...
            if (authenticated==null || !authenticated) {
                        hresp.sendRedirect("../session_expired.html");
                        return;
            }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("AuthControlFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AuthControlFilter(");
